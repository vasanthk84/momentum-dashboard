...
echo.
start "MS · API Server  :3000" cmd /k "title MS - API Server ^(:3000^) && node server.js"
timeout /t 2 /nobreak >nul
start "MS · Vite Client :5173" cmd /k "title MS - Vite Dev  ^(:5173^) && npx vite"
...
echo.
echo  Close this window to stop — or close each server window individually.
pause
